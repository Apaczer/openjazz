...
#define WINDOWED_FLAGS (SDL_RESIZABLE | SDL_DOUBLEBUF | SDL_HWSURFACE | SDL_HWPALETTE)
	...
	#define FULLSCREEN_FLAGS (SDL_FULLSCREEN | SDL_HWSURFACE | SDL_HWPALETTE | SDL_TRIPLEBUF)
#elif defined(MIYOO)
	#define DEFAULT_SCREEN_WIDTH 320
	#define DEFAULT_SCREEN_HEIGHT 240
	...
	#define FULLSCREEN_FLAGS (SDL_FULLSCREEN | SDL_HWSURFACE | SDL_HWPALETTE | SDL_DOUBLEBUF)
#elif defined(DINGOO)
	#define DEFAULT_SCREEN_WIDTH 320
	#define DEFAULT_SCREEN_HEIGHT 240
